...
public abstract class AbstractMacroBaseUnitTestCase
{
    ...
    // Instance variables that can be overridden with System properties
    String cmisRealm = TEST_REALM;
    String cmisUser = TEST_USERNAME;
    String cmisPwd = TEST_PASSWORD;
    ...
    {
        // log4j:
        PropertyConfigurator.configure(AbstractMacroBaseUnitTestCase.class.getClassLoader().getResource("log4j.properties"));
